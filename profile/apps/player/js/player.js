...
video.ontimeupdate = function()
{
    ...
    var slide_par =c_duration*100/t_duration;
    p_bar.style.width = slide_par+"%";  
...
open_video_box_btn.onclick = function()
{
    ...
    if(open_video_box_btn.className == "fa-sharp fa-solid fa-circle-plus")
    {
    ...
    else if(open_video_box_btn.className == "fas fa-times-circle")
    {
        ...
        open_video_box_btn.className = "fa-sharp fa-solid fa-circle-plus";
    }
}
...
//fetch all video from local storage
...
function delete_button()
{
    ...
    for(i=0;i<all_del_btn.length;i++)
    {
        all_del_btn[i].onclick = function()
        {
            ...
            parent.className = "animate_animated animate_bounceOut";
           setTimeout(function()
           {
              parent.remove();
           }, 1000);          
...
// progress bar fixing (forward and backward)
